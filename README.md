...
Add `swift-google-api-servicecontrol-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-api-servicecontrol-v1.git --from 0.1.0-preview
```

Then add `GoogleApiServiceControlV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleApiServiceControlV1 <target-name> --package swift-google-api-servicecontrol-v1
```
